...
module PlotTests =
    ...
    let GPTransferTest () =
        ...
        let hyperPars = {GaussianProcess.Kernel =GaussianProcess.SquaredExponential (1.0f,1.0f);GaussianProcess.MeanFunction = tanHMean; GaussianProcess.Monotonicity = None}
        let range = (-0.5f,0.5f)
