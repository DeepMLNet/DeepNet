...
module CudaExprWorkspaceTypes =
    ...
    type CudaExprWorkspace(recipe: CudaRecipeT) =
        ...
        /// Evaluate expression.
        member this.Eval(externalVar: Map<IVarSpecT, NDArrayDev.NDArrayDev>,
                         hostVar:     Map<IVarSpecT, ArrayND.ArrayND>) =
